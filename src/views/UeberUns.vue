...
onMounted(async () => {
    ...
    smoothScrollTo(0.8, 4000); // Scroll after the content has been loaded
});
</script>
...
<template>
  <div class="page container mx-auto px-4">
    ...
    <section class="bg-green-500 text-white py-12">
      <h1 class="text-4xl font-bold text-center">Über uns</h1>
    </section>
      ...
      <div class="timeline">
        ...
        <div class="timeline-item right">
          <div class="content">
            ...
            <p>
              ...
              Monate die Verantwortung für ein Beet übernehmen. Sie erhalten Tipps und lernen Tricks
              für bis zu drei Ernten in einer Saison. Im Gegenzug leisten diese GärtnerInnen im
              GallusGarten II eine Pacht. Entweder in Form von Arbeitsstunden bei den vertraglichen
              Gemeinschaftsaufgaben (Wässern, Müll einsammeln, Rückschnitte/Grünpflege, …) und beim
              Neubau oder Reparatur von Hochbeeten. Oder falls dies zeitlich oder gesundheitlich
              nicht möglich ist als Spende auf das Vereinskonto.
            </p>
        ...
        <div class="timeline-item left">
          <div class="content">
            ...
            <p>
              Unseren GallusGarten-Galluswarte gibt es nur weil wir dafür freiwillig arbeiten, also
              kostenfrei dieses Klimaprojekt in unzähligen Stunden auf- und weiter bauen. Damit
              täglich 25-40.000 Umsteigende an der Galluswarte auf diesen besonderen Ort in der
              Frankenallee schauen können. Oder sogar reinschauen, um zu sehen was wir hier
        ...
        <div class="timeline-item right">
          <div class="content">
            ...
            <p>
              ...
              Erfolgsgeschichte von sehr unterschiedlichen Gärten und Klimapaten in den Frankfurter
              Stadtteilen: mit besonderen bis beispielhaften Schwerpunkten. Der politische Erfolg
              des aus der BürgerInnen-Initiative „Klimaentscheid“ hat viele Themen der
              GemeinschaftsgärtnerInnen gestärkt. Wir sind erst am Anfang, weil der Klimawandel
              schon heute Frankfurt zu den TOP 5 der heißesten Städte Deutschlands macht.
            </p>
            <img src="https://via.placeholder.com/400x200" alt="August Event Image" />
          </div>
        </div>
        ...
        <div class="timeline-item left">
          <div class="content">
            ...
            <p>
              ...
              zum Aufbau des GallusGarten II darstellte. Am 9. Dezember 2021 gründeten deshalb zehn
              NachbarInnen den Trägerverein „GallusGarten II - Gemeinschaftsgarten an der
        ...
        <div class="timeline-item right">
          <div class="content">
            ...
            <p>
              ...
              Sitzgelegenheiten für die von Covid-geplagten Mitmenschen. Kunstobjekte, wie das „Dach
              für den Garten“, die „12 Stämme“, die „schräge Parkbank“ und Sitzflächen in den
              Beetbuchten sind Teil dieser „sozialen Choreographie“ für Mensch, Flora und Fauna an
              der Frankenallee.
            </p>
            <img src="https://via.placeholder.com/400x200" alt="August Event Image" />
          </div>
        ...
        <div class="timeline-item left">
          <div class="content">
            ...
            <p>
              Im Jul 2024 haben wir 5 Jahre bewegte Geschichte von Förderung des Natur-, Umwelt- und
              Klimaschutzes, sowie der Biodiversitätsbildung geschafft. Ein weiterer, wichtiger
              Gestaltungsgrund im GallusGarten II ist die Kunst + Ästhetik, damit der Garten nicht
              nur ein Experimentierfeld für Selbstversorgung ist. Sondern auch ein sinnlicher Raum
              der Anregung, Bewegung und Begegnung von Menschen in der Stadtnatur.
            </p>
            <img src="https://via.placeholder.com/400x200" alt="March Event Image" />
          </div>
        </div>
        ...
        <div class="timeline-item left">
          <div class="content">
            ...
            <p>
              ...
              Gemeinschaftsgarten für die Nachbarschaft in der Frankenallee direkt in der Grünfläche
              an der Galluswarte? JA, das war und ist eine gute, unterstützenswerte Idee.
            </p>
