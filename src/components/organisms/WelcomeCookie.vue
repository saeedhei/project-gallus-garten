<template>
    <div v-if="!hasVisited" class="welcome-box fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
        ...
        <button @click="dismissWelcome" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700">
        Close
      </button>
    </div>
    </div>
  ...
  import { setCookie, checkCookie } from '../../cookieUtils';
