<template>
  <div class="w-[80vw] flex flex-row justify-start m-2 relative">
    <div class="w-full md:w-3/12 relative dropdown-container">
      ...
      <div
        ...
        class="p-2 w-full text-sm md:text-base text-black bg-green-500 shadow cursor-pointer flex justify-between items-center"
      >
      ...
      >
        ...
        <li
          ...
          class="p-2 cursor-pointer hover:bg-green-200 text-black"
        >
          All Categories
        </li>
        ...
        <li
          ...
          class="p-2 cursor-pointer hover:bg-green-100 text-black"
        >
          {{ category }}
        </li>
      </ul>
